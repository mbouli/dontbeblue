                    ...
                    <div>
                        <form action={saveAccount}>
                            ...
                            <div className="pb-3">
                                ...
                                <p className='pt-5 text-gray-500 text-xs w-5/6 mx-auto'>When you create an account, you agree to our <a href="/terms">terms of service</a> and <a href="/privacy">privacy policy</a>.</p>
                            </div>
                        </form>
                    </div>
                </div>
